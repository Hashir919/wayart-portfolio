  ...
  return (
    <div className="py-32 min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <Link to="/portfolio" className="inline-flex items-center gap-2 text-primary font-black uppercase tracking-[0.3em] text-[10px] mb-16 hover:gap-4 transition-all duration-500 group">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-black mb-8 tracking-tighter leading-[0.9]">{data.name}</h1>
          ...
          {images.length > 0 ? (
            images.map((imgSrc, i) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="group relative aspect-[3/4] rounded-[3rem] overflow-hidden glass-premium border border-white/5 cursor-pointer shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
              >
                <img 
                  src={imgSrc} 
                ...
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-bg-deep/90 via-bg-deep/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
            ...
            <div className="col-span-full py-20 text-center glass-premium rounded-[3rem] border border-white/5 border-dashed">
              <ImageIcon size={48} className="mx-auto text-white/10 mb-4" />
              <p className="text-white/40 uppercase tracking-widest text-xs font-black">Gallery Empty</p>
            </div>
          )}
        </div>
