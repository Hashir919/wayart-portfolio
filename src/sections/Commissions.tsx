...
export default function Commissions() {
  return (
    <section id="commissions" className="py-32 relative overflow-hidden bg-bg-deep/30">
      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className={`relative p-12 h-full rounded-[3.5rem] glass-premium border ${cat.borderColor} flex flex-col items-center text-center overflow-hidden transition-all duration-500`}
                >
                  ...
                  {/* Icon Area */}
                  <div className={`mb-12 w-24 h-24 glass-premium rounded-[2rem] flex items-center justify-center text-white group-hover:scale-110 group-hover:bg-primary group-hover:text-bg-deep transition-all duration-700 shadow-2xl`}>
                    {cat.icon}
                  </div>

                  <h3 className="text-3xl font-black mb-6 text-white tracking-tight group-hover:text-primary transition-colors duration-500">
                    {cat.title}
                  </h3>
                  ...
                  <div className="mt-auto inline-flex items-center gap-2 text-primary text-xs font-black uppercase tracking-widest group-hover:gap-4 transition-all duration-500">
                    View Details
                    <ArrowRight size={16} />
                  </div>
        ...
        >
          <div className="inline-flex items-center gap-3 px-8 py-4 glass-premium rounded-2xl text-white/30 text-[10px] font-black uppercase tracking-[0.3em] shimmer">
